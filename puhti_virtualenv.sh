...
module list
pip --version --> pip 19.2.2 from /appl/soft/ai/miniconda3/envs/tensorflow-1.14.0/lib/python3.7/site-packages/pip (python 3.7)
which pip --> /appl/soft/ai/miniconda3/envs/tensorflow-1.14.0/bin/pip
mkdir PYENVS
cd PYENVS
python -m venv PY373 --system-site-packages
source PY373/bin/activate
which pip --> ~/PYENVS/PY373/bin/pip
pip --version --> pip 19.2.2 from /appl/soft/ai/miniconda3/envs/tensorflow-1.14.0/lib/python3.7/site-packages/pip (python 3.7)
pip install networkx==2.1
ls PY373/lib/python3.7/site-packages/ --> networkx 
python -c "import networkx;print(networkx.__version__);" --> 2.1
